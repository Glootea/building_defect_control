...
/// @nodoc
mixin _$ProjectShallow {

 String get id; String get name;
/// Create a copy of ProjectShallow
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ProjectShallowCopyWith<ProjectShallow> get copyWith => _$ProjectShallowCopyWithImpl<ProjectShallow>(this as ProjectShallow, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProjectShallow&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
...
@override
String toString() {
  return 'ProjectShallow(id: $id, name: $name)';
}
...
/// @nodoc
abstract mixin class $ProjectShallowCopyWith<$Res>  {
  factory $ProjectShallowCopyWith(ProjectShallow value, $Res Function(ProjectShallow) _then) = _$ProjectShallowCopyWithImpl;
@useResult
$Res call({
 String id, String name
});
...
/// @nodoc
class _$ProjectShallowCopyWithImpl<$Res>
    implements $ProjectShallowCopyWith<$Res> {
  _$ProjectShallowCopyWithImpl(this._self, this._then);

  final ProjectShallow _self;
  final $Res Function(ProjectShallow) _then;

/// Create a copy of ProjectShallow
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,}) {
  return _then(ProjectShallow(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,
  ));
...
/// Adds pattern-matching-related methods to [ProjectShallow].
extension ProjectShallowPatterns on ProjectShallow {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
